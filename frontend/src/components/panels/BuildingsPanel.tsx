	...
	return (
		<>
			...
			>
				...
				<p>
					When buildings are enabled, you can click on a building on the map to see
					information about it.
				</p>
				<p>This includes details such as the construction year and the type of building.</p>
			</div>
		</>
	);
}
