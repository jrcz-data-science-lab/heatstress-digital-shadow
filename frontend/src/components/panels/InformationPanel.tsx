...
const DATA_SOURCES: DataSource[] = [
	...
	},
	{
		...
		license: 'CC BY 4.0',
		url: 'https://3dbag.nl',
		description: '3D building geometry derived from AHN point cloud and BAG data.',
	},
	{
		name: 'EP-Online',
	...
	},
	{
		...
		description: 'Building addresses, construction years, unit status, and footprints.',
	},
	{
		...
		description: 'Existing trees in public space, delivered via the PDOK OGC API.',
	},
];
		...
		<div style={{ padding: '0 4px' }}>
			...
			>
				...
				<p style={{ margin: '4px 0', color: '#333' }}>
					Heatstress Digital Shadow is a decision-support tool for visualising urban heat
					stress and evaluating green interventions in municipalities.
				</p>
			</div>
